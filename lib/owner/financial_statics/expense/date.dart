...
import 'package:work03/owner/financial_statics/income/date.dart';
...
class date_finance extends StatelessWidget {
  @override
  int select = 0;
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => financial1_date_homepage(),
                            ),
                          );
                        },
                      ),
...
class financial_date_homepage extends StatefulWidget {
  @override
  _financial_date_homepageState createState() =>
      _financial_date_homepageState();
}

class _financial_date_homepageState extends State<financial_date_homepage> {
  int selectedIndex = 0;
  int choose = 1;
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      ...
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
                      color: Color.fromARGB(255, 241, 53, 40)),
                ),
              ),
              SizedBox(
                width: 50,
...
class financial1_date_homepage extends StatefulWidget {
  @override
  _financial1_date_homepageState createState() =>
      _financial1_date_homepageState();
}

class _financial1_date_homepageState extends State<financial1_date_homepage> {
  int selectedIndex = 0;
  int choose = 1;
          ...
          child: Row(
            children: <Widget>[
              ...
              Container(
                ...
                alignment: Alignment(-14.9, -1),
                child: Text(
                  "Total Branch's Electricity Cost",
                  style: TextStyle(
                      fontFamily: 'Montserrat',
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
