...
class income_month_finance extends StatelessWidget {
  @override
  int select = 1;
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => financial_income_month_homepage(),
                  ),
                );
              },
              child: Container(
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  financial1_income_month_homepage(),
                            ),
                          );
                        },
                      ),
...
class financial_income_month_homepage extends StatefulWidget {
  @override
  _financial_income_month_homepageState createState() =>
      _financial_income_month_homepageState();
}

class _financial_income_month_homepageState
    extends State<financial_income_month_homepage> {
  int selectedIndex = 0;
  int choose = 1;
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  financial_income_month_homepage(),
...
class financial1_income_month_homepage extends StatefulWidget {
  @override
  _financial1_income_month_homepageState createState() =>
      _financial1_income_month_homepageState();
}

class _financial1_income_month_homepageState
    extends State<financial1_income_month_homepage> {
  int selectedIndex = 0;
  int choose = 1;
